                ...
                <ul class="list-unstyled topbar-nav float-right mb-0"> 
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                            ...
                            <i data-feather="log-in" class="align-self-center menu-icon icon-dual"></i>
                            <span class="ml-1 nav-user-name hidden-sm">Login <i class="mdi mdi-chevron-down"></i> </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="/"><i class="dripicons-user text-muted mr-2"></i> Student</a>
