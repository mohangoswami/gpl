    ...
    <div class="col-lg-6">
        <div class="card m-5">
            <div class="card-body">
                ...
                <img src="{{ URL::asset('assets/images/teacherImg/' . $teacher->name)}}" alt="{{$teacher->name}}" class="rounded-circle thumb-xl">                                        
                ...
                <form action={{ route('editTeacherRecord') }} method="POST" enctype="multipart/form-data">
                    @csrf
